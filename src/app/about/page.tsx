  ...
  return (
    <div className="bg-white pt-28 pb-20 min-h-screen">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        {/* Header */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 border-b border-border pb-16 mb-20 items-center">
          <div className="lg:col-span-7">
            <span className="text-[10px] font-bold tracking-widest text-[#8A6A44] uppercase">{sc.aboutTagline}</span>
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-[#222222] mt-3 leading-tight text-pretty">
              {sc.aboutHeading} <br />
              <span className="text-[#7A2E2E]">{sc.aboutHeadingAccent}.</span>
            </h1>
          ...
          <div className="lg:col-span-5 bg-[#F8F8F6] border border-[#E2E2DF] p-8">
            ...
            <div className="text-2xl font-extrabold text-[#222222] tracking-tight">{sc.ownerName}</div>
            <div className="text-xs font-semibold text-[#7A2E2E] uppercase tracking-wider mt-1">{sc.aboutOwnerTitle}</div>
            <p className="text-xs text-[#666666] leading-relaxed mt-4">{sc.aboutOwnerQuote}</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-start mb-24">
          ...
          <div className="lg:col-span-7 space-y-6 text-[#666666] text-sm leading-relaxed">
            <p>{sc.aboutParagraph1}</p>
            <p>{sc.aboutParagraph2}</p>
            <p>{sc.aboutParagraph3}</p>
          </div>
        </div>
        ...
        <div className="border-t border-border pt-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              { Icon: HeartHandshake, title: "Owner Integrity", desc: `${sc.ownerName} stands behind every sale, assisting personally with setups and claims.` },
