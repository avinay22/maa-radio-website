          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <div className="p-6 bg-[#FAF9F6] border border-[#E2E2DF] rounded-2xl flex items-baseline gap-4 flex-wrap">
              {product.discountPrice ? (
                <>
                  <span className="text-3xl sm:text-4xl font-black text-[#7A2E2E]">
                    {product.discountPrice}
                  </span>
                  ...
                  {product.discountPercentage && (
                    <span className="bg-[#7A2E2E] text-white text-xs font-bold uppercase tracking-wider px-3 py-1 rounded-full ml-auto">
